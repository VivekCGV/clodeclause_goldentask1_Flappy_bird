...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\bird.png'
BACKGROUND = 'C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\bg.jpeg'
PIPE = 'C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\pipe.png'
    ...
    while True:
        for event in pygame.event.get():
            ...
            if playbutton.collidepoint(pygame.mouse.get_pos()): #checking if mouse is collided with the play button
                ...
                #Adding INRO Music
                pygame.mixer.music.load('C:/Users/vivek/Downloads/resources/AUDIO/INTROMUSIC.mp3')
...
def mainGame():
    ...
    pygame.mixer.music.load('C:/Users/vivek/Downloads/resources/AUDIO/BGMUSIC.mp3')
    pygame.mixer.music.play()
    score = 0
    playerx = int(SCREENWIDTH/5)
...
def gameOver():
    ...
    GAME_SPRITES['OVER'] = pygame.image.load('C:/Users/vivek/Downloads/resources/SPRITES/gameover.png').convert_alpha()
    GAME_SPRITES['RETRY'] = pygame.image.load('C:/Users/vivek/Downloads/resources/SPRITES/retry.png').convert_alpha()
    GAME_SPRITES['HOME'] = pygame.image.load('C:/Users/vivek/Downloads/resources/SPRITES/Home.png').convert_alpha()
    SCREEN.blit(GAME_SPRITES['background'],(0,0))
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['numbers'] = (
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\0.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\1.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\2.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\3.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\4.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\5.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\6.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\7.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\8.png').convert_alpha(),
        pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\9.png').convert_alpha(),
    ...
    GAME_SPRITES['message'] = pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\message.png').convert_alpha()
    GAME_SPRITES['base'] = pygame.image.load('C:\\Users\\vivek\\Downloads\\resources\\SPRITES\\base.png').convert_alpha()
    GAME_SPRITES['pipe'] = (
    ...
    #Game Sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('C:\\Users\\vivek\\Downloads\\resources\\AUDIO\\die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('C:\\Users\\vivek\\Downloads\\resources\\AUDIO\\hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('C:\\Users\\vivek\\Downloads\\resources\\AUDIO\\point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('C:\\Users\\vivek\\Downloads\\resources\\AUDIO\\swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('C:\\Users\\vivek\\Downloads\\resources\\AUDIO\\wing.wav')
    while True:
